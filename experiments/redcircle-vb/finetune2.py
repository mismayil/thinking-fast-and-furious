...
if __name__ == "__main__":
    ...
    checkpoint_dir = f"{MNT_POINT}/nlpdata1/home/ismayilz/cs503-project/models/idefics2-8b-chain"
    ...
    training_args = TrainingArguments(
        ...
        report_to="wandb",
        save_total_limit=2,
        run_name="idefics2-8b-chain"
    )

    data_collator = GVQADataCollator(processor, apply_redcircle=False, apply_input_masking=True)
