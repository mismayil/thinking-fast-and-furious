...
if __name__ == "__main__":
    ...
    idefics_train_data_path = f"{HOME}/thinking-fast-and-furious/experiments/redcircle-vb/data/nuscenes/train_idefics_chain_od.json"
    # idefics_train_data_path = f"{MNT_POINT}/nlpdata1/home/ismayilz/cs503-project/thinking-fast-and-furious/experiments/redcircle-vb/data/nuscenes/train_idefics_chain_od.json"
    checkpoint_dir = f"{HOME}/tff-models/idefics2-8b-chain-od"
    # checkpoint_dir = f"{MNT_POINT}/nlpdata1/home/ismayilz/cs503-project/models/idefics2-8b-chain-od"
