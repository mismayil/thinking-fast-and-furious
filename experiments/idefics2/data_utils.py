...
class GVQADataCollator:
    ...
    def _build_chat_template_mask(self, input_ids):
        """
        masking out the tokens related to the user message and system tokens in the chat template 
        """
    ...
    def _build_pad_mask(self, input_ids):
        """
        masking out the tokens related to the user message and system tokens in the chat template 
        """
    ...
    def __call__(self, examples):
        ...
        labels_mask = self._build_pad_mask(batch["input_ids"])
